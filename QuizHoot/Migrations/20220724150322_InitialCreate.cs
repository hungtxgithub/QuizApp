        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelName = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinishAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    Score = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TakeQuiz", x => x.TakeQuizID);
                    table.ForeignKey(
                        name: "FK_TakeQuiz_Quiz_QuizID",
                        column: x => x.QuizID,
                        principalTable: "Quiz",
                        principalColumn: "QuizId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TakeQuiz_User_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TakeAnswer", x => new { x.TakeQuizID, x.AnswerID });
                    table.ForeignKey(
                        name: "FK_TakeAnswer_Answer_AnswerID",
                        column: x => x.AnswerID,
                        principalTable: "Answer",
                        principalColumn: "AnswerID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TakeAnswer_TakeQuiz_TakeQuizID",
                        column: x => x.TakeQuizID,
                        principalTable: "TakeQuiz",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TakeAnswer_AnswerID",
                table: "TakeAnswer",
                column: "AnswerID");

            migrationBuilder.CreateIndex(
                name: "IX_TakeQuiz_QuizID",
                table: "TakeQuiz",
                column: "QuizID");

            migrationBuilder.CreateIndex(
                name: "IX_TakeQuiz_UserID",
                table: "TakeQuiz",
                column: "UserID");
        }
